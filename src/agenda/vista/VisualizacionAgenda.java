 ...
 * @author A13004191
 */
public class VisualizacionAgenda extends javax.swing.JFrame {

    /**
     * Creates new form VisualizacionAgenda
     */
    public VisualizacionAgenda() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hora inicio", "Hora final", "Cliente", "Servicios", "Productos", "e-mail", "Hora de notificación"
            }
        ) {
        ...
        jTable2.setMinimumSize(new java.awt.Dimension(2500, 500));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizacionAgenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisualizacionAgenda().setVisible(true);
            }
        });
    }
